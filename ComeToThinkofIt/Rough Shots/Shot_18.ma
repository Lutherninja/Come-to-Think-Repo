...
//Name: Shot_18.ma
//Last modified: Fri, Aug 28, 2020 03:33:25 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -607.57662865887789 47.622838203632305 -202.52146997033722 ;
	setAttr ".r" -type "double3" -6.3383527296026134 216.19999999999547 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "FE249CDE-412A-295D-485F-5389627878B0";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 304.24158324754046;
...
createNode transform -n "Main_Cam";
	...
	setAttr ".t" -type "double3" -486.60634871753547 3.2836409615720541 -63.654627622346361 ;
	setAttr ".r" -type "double3" 0 194.99999999999989 0 ;
...
createNode transform -n "pSphere1";
	rename -uid "5EE8EB49-404F-644E-578D-439C3ABE549C";
createNode mesh -n "pSphereShape1" -p "pSphere1";
	rename -uid "8204635E-4D10-059A-610E-51B45E2ED0ED";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "88D3EE82-4534-518D-6B6B-39B8A5057D8D";
	setAttr -s 69 ".lnk";
	setAttr -s 69 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B378C18B-4EFE-1638-26CD-56A8CD3D75D4";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 0 1 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "346550A9-4EB4-F330-EE49-ECB14C172F46";
createNode displayLayerManager -n "layerManager";
	rename -uid "2B58273E-44B9-2A22-80B0-EE8A67DB6202";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A6F37AB1-4C51-4E5D-D951-1C9FA6E6D818";
...
createNode reference -n "Boy_Rig_FinalRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "Boy_Rig_Final:Geo_Layer" "visibility" " 0"
...
createNode polySphere -n "polySphere1";
	rename -uid "ABDBE3A3-4C9E-0501-21C6-6183335C68C6";
createNode animCurveTL -n "pSphere1_translateX";
	rename -uid "E323AD3E-487B-284C-D24F-3C81BFF89E4D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 -507.58077768609411 4 -495.2840121077304
		 7 -486.23524891604842 11 -475.646777604151 15 -462.36617542151691;
createNode animCurveTL -n "pSphere1_translateY";
	rename -uid "6B1DF2A1-4A15-8A6B-4052-59B6B4919398";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 12.071764754445979 4 0.8636025936152345
		 7 4.2942122094039945 11 -0.21518634072243259 15 -0.38371148619894768;
createNode animCurveTL -n "pSphere1_translateZ";
	rename -uid "979DE665-4D23-CF2B-375A-76B67F162690";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -0.14312121272087097 11 6.4222183960149692;
createNode animCurveTU -n "pSphere1_visibility";
	rename -uid "A7C1D59B-41E7-5B01-7A7F-1EAF09372E1B";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1;
	setAttr ".kot[0]"  5;
createNode animCurveTA -n "pSphere1_rotateX";
	rename -uid "314208B6-4624-6F11-E596-FB966B68709B";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0;
createNode animCurveTA -n "pSphere1_rotateY";
	rename -uid "116561AE-460A-1039-6860-82A678ED029A";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0;
createNode animCurveTA -n "pSphere1_rotateZ";
	rename -uid "547CFC37-4D35-C192-42AE-12B58F63BA04";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0;
createNode animCurveTU -n "pSphere1_scaleX";
	rename -uid "06AA10EA-4BB2-668C-B8A7-7EA5DE416876";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 6.3133242309993838;
createNode animCurveTU -n "pSphere1_scaleY";
	rename -uid "C802FC89-4EED-F2D2-AD2A-D2B7C6535CD3";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 6.3133242309993838;
createNode animCurveTU -n "pSphere1_scaleZ";
	rename -uid "83AADED9-47A8-C26F-50A6-99BA3876BDE1";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 6.3133242309993838;
select -ne :time1;
